...
import { innerJoin as original } from './innerJoin.js';
 ...
 *  innerJoin method calls the keyFn function one time for each
 *  element in the array.
 * @param keyComparerFn - An optional function that accepts two arguments.
 *  The innerJoin method calls the keyComparerFn function to determine the
 ...
 *  matching each key.
 */
export const innerJoin = asPipeable(original);
